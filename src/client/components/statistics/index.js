    ...
    return (
      <div>
        ...
        <div id='grid'>
          ...
          <div>
            <canvas className='canvasChart' id="myChart2" width="100" height="100"></canvas>
          </div>
          <div>
            <canvas className='canvasChart' id="myChart3" width="100" height="100"></canvas>
          </div>
          <div>
            <canvas className='canvasChart' id="myChart4" width="100" height="100"></canvas>
          </div>
        </div>
